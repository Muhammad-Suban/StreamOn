      ...
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="mt-8 border-b border-neutral-800 overflow-x-auto">
          <nav className="flex gap-8 min-w-max">
            <button className="px-4 py-2 text-white border-b-2 border-red-600">Videos</button>
            <button className="px-4 py-2 text-gray-400 hover:text-white">Playlist</button>
            <button className="px-4 py-2 text-gray-400 hover:text-white">Favorites</button>
            <button className="px-4 py-2 text-gray-400 hover:text-white">Following</button>
          </nav>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 2xl:grid-cols-4 gap-4 py-8">
          {Array(8).fill(null).map((_, index) => (
            <div key={index} className="bg-neutral-900 rounded-lg overflow-hidden hover:bg-neutral-800 transition-colors">
              ...
              <div className="p-3">
                ...
                <p className="text-sm text-gray-400 mt-2">24K views • 2 days ago</p>
              </div>
            </div>
          ))}
        </div>
